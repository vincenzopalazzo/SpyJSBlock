...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('jquery')) : typeof define === 'function' && define.amd ? define(['exports', 'jquery'], factory) : factory(global.material = {}, global.jQuery);
  ...
  var picker = createCommonjsModule(function (module, exports) {
    ...
    (function (factory) {
      // AMD.
      if (typeof undefined == 'function' && undefined.amd) undefined('picker', ['jquery'], factory); // Node.js/browserify.
      ...
      function PickerConstructor(ELEMENT, NAME, COMPONENT, OPTIONS) {
        ...
        P = PickerInstance.prototype = {
          ...
          start: function () {
            ...
            if (SETTINGS.containerHidden) $$$1(SETTINGS.containerHidden).append(P._hidden);else $ELEMENT.after(P._hidden); // Insert the root as specified in the settings.

            if (SETTINGS.container) $$$1(SETTINGS.container).append(P.$root);else $ELEMENT.after(P.$root); // Bind the default component and settings events.
        ...
        function prepareElementHolder() {
          P.$holder.on({
            ...
            'mousedown click': function (event) {
              var target = event.target; // Make sure the target isn’t the root holder so it can bubble up.
          ...
          on('click', '[data-pick], [data-nav], [data-clear], [data-close]', function () {
            ...
            activeElement = activeElement && (activeElement.type || activeElement.href); // If it’s disabled or nothing inside is actively focused, re-focus the element.
        ...
        function prepareElementHidden() {
          ...
          P._hidden = $$$1('<input ' + 'type=hidden ' + // Create the name using the original input’s with a prefix and suffix.
      ...
      function getScrollbarWidth() {
        ...
        var $outer = $$$1('<div style="visibility:hidden;width:100px" />').appendTo('body'); // Get the width without scrollbars.

        var widthWithoutScroll = $outer[0].offsetWidth; // Force adding scrollbars.

        $outer.css('overflow', 'scroll'); // Add the inner div.

        var $inner = $$$1('<div style="width:100%" />').appendTo($outer); // Get the width with scrollbars.
      ...
      PickerConstructor._ = {
        ...
        node: function (wrapper, item, klass, attribute) {
          ...
          item = $$$1.isArray(item) ? item.join('') : item; // Check for the class
  ...
  var picker_date = createCommonjsModule(function (module, exports) {
    ...
    (function (factory) {
      ...
      /*, options*/
        ...
        var calendar = this; // If it’s anything false-y, remove the limits.
      ...
      DatePicker.prototype.disabled = function (dateToVerify) {
        ...
        isDisabledMatch = isDisabledMatch.length && !isDisabledMatch.filter(function (dateToDisable) {
          return $$$1.isArray(dateToDisable) && dateToDisable[3] == 'inverted' || $$$1.isPlainObject(dateToDisable) && dateToDisable.inverted;
      ...
      DatePicker.prototype.isDateExact = function (one, two) {
        ...
        if ((_.isDate(one) || $$$1.isArray(one)) && (_.isDate(two) || $$$1.isArray(two))) {
        ...
        if (datesToDisable == 'flip') {
          ...
          disabledItems = [];
            ...
            datesToDisable.map(function (unitToDisable) {
              ...
              if (!matchFound) {
                if (_.isInteger(unitToDisable) || _.isDate(unitToDisable) || $$$1.isArray(unitToDisable) || $$$1.isPlainObject(unitToDisable) && unitToDisable.from && unitToDisable.to) {
