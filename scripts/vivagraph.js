!function (e) {
  if ('object' == typeof exports && 'undefined' != typeof module) module.exports = e();else if ('function' == typeof define && define.amd) define([], e);else {
    var f;
    'undefined' != typeof window ? f = window : 'undefined' != typeof global ? f = global : 'undefined' != typeof self && (f = self), f.Viva = e();
  }
}(function () {
  ...
  return function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
      ...
      './Algorithms/centrality.js': 36,
      './Algorithms/operations.js': 37,
      './Input/domInputManager.js': 38,
      './Input/dragndrop.js': 39,
      './Input/webglInputManager.js': 40,
      './Layout/constant.js': 41,
      './Utils/backwardCompatibleEvents.js': 42,
      './Utils/browserInfo.js': 43,
      './Utils/findElementPosition.js': 45,
      './Utils/getDimensions.js': 46,
      './Utils/intersectRect.js': 47,
      './Utils/rect.js': 49,
      './Utils/timer.js': 50,
      './View/renderer.js': 52,
      './View/svgGraphics.js': 53,
      './View/webglGraphics.js': 54,
      './WebGL/parseColor.js': 55,
      './WebGL/texture.js': 56,
      './WebGL/webgl.js': 57,
      './WebGL/webglAtlas.js': 58,
      './WebGL/webglImage.js': 59,
      './WebGL/webglImageNodeProgram.js': 60,
      './WebGL/webglInputEvents.js': 61,
      './WebGL/webglLine.js': 62,
      './WebGL/webglLinkProgram.js': 63,
      './WebGL/webglNodeProgram.js': 64,
      './WebGL/webglSquare.js': 65,
      './version.js': 66,
      'gintersect': 3,
      'ngraph.events': 9,
      'ngraph.forcelayout': 11,
      'ngraph.fromjson': 13,
      'ngraph.generators': 14,
      'ngraph.graph': 16,
      'ngraph.merge': 17,
      'ngraph.random': 30,
      'ngraph.tojson': 31,
    ...
    3: [function (require, module, exports) {
      ...
      function intersect(x1, y1, x2, y2, // first line segment
    ...
    5: [function (require, module, exports) {
      ...
      function betweennes(graph, oriented) {
        ...
        var pred = Object.create(null); // distance from source

        var dist = Object.create(null); // number of shortest paths from source to key

        var sigma = Object.create(null); // dependency of source on key
    ...
    6: [function (require, module, exports) {
      ...
      function closeness(graph, oriented) {
        var Q = []; // list of predcessors on shortest paths from source
        ...
        function accumulate() {
          ...
          var reachableNodesTotal = distances.length; // Compute sum of all distances for node
    ...
    19: [function (require, module, exports) {
      ...
      './lib/createBody': 21,
      './lib/dragForce': 22,
      './lib/eulerIntegrator': 23,
      './lib/spring': 24,
      './lib/springForce': 25,
      'ngraph.events': 9,
      'ngraph.expose': 10,
      'ngraph.merge': 17,
      'ngraph.quadtreebh': 26
    }],
    ...
    39: [function (require, module, exports) {
      ...
      var findElementPosition = require('../Utils/findElementPosition.js'); // TODO: Move to input namespace
    ...
    42: [function (require, module, exports) {
      ...
      function backwardCompatibleEvents(g) {
        ...
        var eventsDefined = g.on !== undefined || g.off !== undefined || g.fire !== undefined;
    ...
    54: [function (require, module, exports) {
      ...
      function webglGraphics(options) {
        ...
        var graphics = {
           ...
           */
          beginRender: function () {// this function could be replaced by this.init,
          ...
          init: function (c) {
            ...
            if (options.clearColor) {
              ...
              gl.clearColor(color.r, color.g, color.b, color.a); // TODO: not the best way, really. Should come up with something better
            ...
            nodeProgram.load(gl);
            nodeProgram.updateSize(width / 2, height / 2);
            updateTransformUniform(); // Notify the world if someone waited for update. TODO: should send an event
          ...
          */
          release: function (container) {
            if (graphicsRoot && container) {
              container.removeChild(graphicsRoot); // TODO: anything else?
            }
          },
          ...
          releaseNode: function (node) {
            ...
            if (nodeIdToRemove < nodesCount) {
              ...
              lastNodeUI.id = nodeIdToRemove; // Since concrete shaders may cache properties in the UI element
          ...
          setNodeProgram: function (newProgram) {
            if (!gl && newProgram) {
              ...
              throw 'Not implemented. Cannot swap shader on the fly... Yet.'; // TODO: unload old shader and reinit.
            }
          },
          ...
          transformClientToGraphCoordinates: function (p) {
            ...
            // normalize
            p.x = 2 * p.x / width - 1;
            p.y = 1 - 2 * p.y / height; // apply transform

            p.x = (p.x - transform[12]) / transform[0];
            p.y = (p.y - transform[13]) / transform[5]; // transform to graph coordinates
          ...
          transformGraphToClientCoordinates: function (p) {
            ...
            p.x = p.x / (width / 2);
            p.y = p.y / (-height / 2); // apply transform

            p.x = p.x * transform[0] + transform[12];
            p.y = p.y * transform[5] + transform[13]; // denormalize
          ...
          getNodeAtClientPos: function (clientPos, preciseCheck) {
            ...
            this.transformClientToGraphCoordinates(clientPos); // now using precise check iterate over each node and find one within box:
      ...
      function webglImageNodeProgram() {
        ...
        function createNode(ui) {
          ...
          if (coordinates) {
            ...
            ui._offset = 0; // Image is not yet loaded into the atlas. Reload it:
    ...
    61: [function (require, module, exports) {
      ...
      function webglInputEvents(webglGraphics) {
        ...
        function startListen(root) {
          ...
          updateBoundRect(); // mouse move inside container serves only to track mouse enter/leave events.
          ...
          root.addEventListener('mousedown', function (e) {
            ...
            if (args[0]) {
              cancelBubble = invoke(mouseDownCallback, args); // we clicked on a node. Following drag should be handled on document events:
...
//# sourceMappingURL=vivagraph.js.map
